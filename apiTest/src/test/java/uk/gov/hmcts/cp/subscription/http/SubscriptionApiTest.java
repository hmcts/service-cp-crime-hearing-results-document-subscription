...
public class SubscriptionApiTest extends BaseTest {
    ...
    private UUID clientId = UUID.fromString("11111111-2222-3333-4444-555555555555");
    private String bearerToken = JwtHelper.bearerTokenWithAzp(clientId);
...
//    }
    ...
    void round_trip_subscription_should_work_ok() throws InterruptedException {
        ...
        try {
            UUID subscriptionId = createSubscription(clientId, "https://mycallback");
