...
class NotificationControllerTest {
    ...
    void get_pcr_document_should_return_200_with_content_from_manager() throws Exception {
        ...
        DocumentContent content = DocumentContent.builder()
                ...
                .build();
        when(notificationManager.getPcrDocumentContent(eq(resolvedClientUuid), eq(subscriptionId), eq(documentId))).thenReturn(content);
        ...
        verify(notificationManager).getPcrDocumentContent(resolvedClientUuid, subscriptionId, documentId);
    }
}
