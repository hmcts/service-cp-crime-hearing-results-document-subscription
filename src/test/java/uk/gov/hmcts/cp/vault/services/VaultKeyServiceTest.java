...
class VaultKeyServiceTest {
    ...
    void generateAndStore_should_generate_random_key() {
        ...
        assertThat(keyPair.getKeyId()).matches("^kid-[a-z0-9\\-]{36}$");
    ...
    void generateAndStore_should_store_via_secret_service() {
        ...
        verify(secretService).setSecret(VaultKeyService.toVaultSecretName(subscriptionId), "base64encoded");
    }
    ...
    void getKeyPair_should_decode_secret_from_secret_service() {
        ...
        verify(secretService).getSecret(VaultKeyService.toVaultSecretName(subscriptionId));
    }
}