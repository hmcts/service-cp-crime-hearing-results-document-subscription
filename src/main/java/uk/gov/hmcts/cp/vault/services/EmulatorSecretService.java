...
public class EmulatorSecretService {
    ...
    public SecretClient build(final String vaultUrl) throws Exception {
        final SslContext nettySslContext = SslContextBuilder.forClient()
    ...
    static String fetchToken(final HttpClient reactorClient, final String tokenUrl) {
    ...
    /* default */ static final class StaticBearerTokenPolicy implements HttpPipelinePolicy {

        private final String headerValue;

        @SuppressWarnings("PMD.CommentDefaultAccessModifier")
        StaticBearerTokenPolicy(final String token) {
